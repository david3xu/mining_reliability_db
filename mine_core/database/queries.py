...
Core queries for mining reliability data - UPDATED VERSION
"""
...
def get_department(action_request_id: str) -> Optional[Dict[str, Any]]:
    ...
    query = """
    MATCH (d:Department)-[:ASSIGNED_TO]->(ar:ActionRequest {actionrequest_id: $action_request_id})
    RETURN d.department_id AS id,
