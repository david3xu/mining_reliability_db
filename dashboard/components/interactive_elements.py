...
def create_interactive_metric_card(value: Any, label: str, href: str = None, card_id: str = None) -> html.A:
    ...
    card_content = [
        html.H2(display_value, style={"fontSize": "32px", "fontWeight": "bold", "margin": "0", "color": "#FFFFFF"}),
        html.P(label, style={"fontSize": "14px", "margin": "5px 0 0 0", "color": "#FFFFFF", "opacity": "0.9"})
    ]
    ...
    return html.A(card_content, href=href, style=card_style, id=card_id, className="metric-card-hover")

def create_interactive_pie_chart(data: Dict[str, Any], chart_id: str = "interactive-pie") -> dcc.Graph:
...
def create_interactive_bar_chart(data: Dict[str, Any], chart_id: str = "interactive-bar") -> dcc.Graph:
...
def create_interactive_data_table(data: List[Dict], columns: List[str], table_id: str = "interactive-table") -> dash_table.DataTable:
