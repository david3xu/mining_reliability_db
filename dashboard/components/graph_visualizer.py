        ...
        if not has_data:
            return html.Div([
                dbc.Alert([
                    ...
                    html.P("Insufficient data for network analysis. Requires minimum incident patterns.")
                ], color="warning")
            ])
    ...
    try:
        ...
        fig.add_trace(go.Scatter(
            ...
            marker=dict(
                ...
                color=styling_config.get("chart_colors", ["#4A90E2"])[0:len(facility_data.labels)],
                line=dict(width=2, color=styling_config.get("border_color", "#CCCCCC"))
            ),
            text=[label[:15] + '...' if len(label) > 15 else label for label in facility_data.labels],
        ...
        return html.Div([
            ...
            html.P([
                ...
                html.Small("Full interactive flow diagram in Phase 6 implementation.", className="text-muted")
            ])
        ])
            ...
            dbc.CardBody([
                ...
                html.P([
                    ...
                    html.Ul([
                        ...
                        html.Li("Filter by facility, time period, or cause type"),
    ...
    try:
        ...
        header = html.Div([
            ...
            dbc.Alert([
                ...
                dbc.ButtonGroup([
                    dbc.Button("Portfolio Overview", href="/", color="primary", size="sm"),
                    dbc.Button("Documentation", disabled=True, color="secondary", size="sm")
                ])
        ...
        content = dbc.Container([
            dbc.Row([
                ...
                dbc.Col([
                    create_interactive_node_explorer()
                ], md=4)
            ], className="mb-4"),
