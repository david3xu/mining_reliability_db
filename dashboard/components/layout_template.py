...
def create_standard_layout(tab_id: str, metric_cards: List[Any], left_component: Any,
                          right_component: Any, summary_component: Any,
                          summary_title: str = "Analysis Summary") -> html.Div:
...
def create_tab_header(tab_id: str) -> html.Div:
    ...
    return html.Div([
        html.H1(metadata.get("title", "Analysis Dashboard"),
               className="text-primary mb-2", style={"fontSize": "28px", "fontWeight": "bold"}),
        html.H4(metadata.get("subtitle", "Data Analysis"),
               className="text-muted mb-4", style={"fontSize": "18px", "fontWeight": "normal"})
