    ...
    try:
        ...
        for pattern in patterns[:20]:  # Top 20
            table_data.append({
                ...
                "Impact": "High" if pattern.get("frequency", 0) > 5 else "Medium" if pattern.get("frequency", 0) > 2 else "Low"
            })
    ...
    try:
        ...
        return html.Div([
            ...
            dbc.Container([
                ...
                html.H2(f"{facility_name} - Detailed Analysis", className="text-primary mb-4")
            ], fluid=True),
